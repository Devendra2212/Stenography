...
def help_menu():
    ...
    if not help_opened:
        ...
        text_to_decode_label = Label(help_window, text="\n Steganographyx\nDeveloped by @devendraprasadmahto\nLinkedIn-https://www.linkedin.com/in/devendra-prasad-mahto-6b8268277?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app\n")
...
# Load the logo image
logo = Image.open("Steganography\icon.png")
...
# Footer label
footer_label = Label(window, text="Developed By Devendra Prasad Mahto")
